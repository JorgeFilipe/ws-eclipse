import java.util.Locale; /// importação para utilizar o Locale.setDefault
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// importação necessária java.util.Locale
			...
			System.out.printf("Separador de decimais Brasil: %.4f%n", x);// O número exibido está com vírgula por causa do idioma, no Portugues o separador de decimais é a vírgula (,).
		...
		// CASTING = Conversão explícita dos valores;
			...
			a=5;
			b=2;
			resultado = (double) a/b; // CASTING aplicado aqui sem o (double) irá retornar apenas 2.0 e não o valor decimal.
			System.out.println(resultado);
			double c;
			int d;
			c = 5.0;
			d = (int) c; // CASTING aplicado aqui convertendo double para inteiro não se importando com a possível perda de informação
		...
		*/
		...
		if(login.equals(confLogin) && senha.equals(confSenha)) {
			// variavel.equals(variavel alvo da comparação) --> como comparar String c/ String
